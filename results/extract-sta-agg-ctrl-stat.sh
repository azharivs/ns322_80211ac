...
echo "Column order: [Time] [error] [control signal] [cur time allowance msec] [new time allowance msec] [integral] [derivative] [reference] [total time allowance] [adjust/Error Correlation] [thrHigh] [thrLow]"
echo "-----------------------------------------------------------------------------------------------------------------------------------"
